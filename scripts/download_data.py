...
def main():
    parser = argparse.ArgumentParser(description='Download historical market data from Alpaca')
    ...
    parser.add_argument('--timeframe', default='1Day', help='Bar timeframe (1Day, 1Hour, etc.)')

...
def main():
    ...
    if data is None:
        ...
        try:
            ...
            print(f"    .venv\\Scripts\\python.exe scripts\\download_data.py {symbol} --start {start_date}")
            return
    else:
    ...
    print(f"     .venv\\Scripts\\python.exe scripts\\run_backtest.py {symbol} --strategy MovingAverageCrossover --fast-window 10 --slow-window 30")
    print("\n  2. Test a different strategy:")
    print(f"     .venv\\Scripts\\python.exe scripts\\run_backtest.py {symbol} --strategy MeanReversion --window 20 --num-std 2.0")
    print("\n  3. Visualize results:")
    print(f"     .venv\\Scripts\\python.exe scripts\\run_backtest.py {symbol} --strategy MovingAverageCrossover --plot")
    print("\n  4. Download more symbols:")
    print(f"     .venv\\Scripts\\python.exe scripts\\download_data.py MSFT GOOGL TSLA --start {start_date}")

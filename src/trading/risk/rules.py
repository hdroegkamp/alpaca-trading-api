...
class RiskManager:
    ...
    def check_daily_loss(self, daily_pnl: float, portfolio_value: float) -> Tuple[bool, Optional[str]]:
    ...
    def check_drawdown(self, current_equity: float, peak_equity: float) -> Tuple[bool, Optional[str]]:
